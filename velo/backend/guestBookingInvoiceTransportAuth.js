import { guestBookingInvoiceDeliveryBoundOperation } from 'backend/guestBookingInvoiceDelivery';
...
export async function verifyTransportRequest(originalBytes,headers){
 ...
 need(transportEnabled()===true);const handle=registerVerifiedTransportRequest(entry);
